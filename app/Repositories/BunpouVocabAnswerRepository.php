...
class BunpouVocabAnswerRepository
{
    public function create($data)
    {
        foreach($data['answer'] as $k => $v){
            $answer = new BunpouVocabAnswer();
    ...
    {
        foreach($data['answer'] as $k => $v){
            $answer = BunpouVocabAnswer::find($v['id']);
    ...
    {
        $answer = BunpouVocabAnswer::where("question",$id);
        $answer->delete();
    ...
    {
        $answer = BunpouVocabAnswer::findOrFail($id);
