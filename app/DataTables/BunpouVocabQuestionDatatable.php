...
class BunpouVocabQuestionDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function($question){
                $__route_name = 'bunpou.vocabulary.question.edit';
                $__route_name_delete = 'bunpou.vocabulary.question.destroy';
     ...
     *
     * @param \App\BunpouVocabQuestion $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BunpouVocabQuestion $model)
    {
