...
class SuujiModuleTestDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function($test){
                $__route_name = 'suuji.module.test.edit';
                $__route_name_delete = 'suuji.module.test.destroy';
                $edit_url = route($__route_name, $test->id);
                $delete_url = route($__route_name_delete, $test->id);

                $deactivate_record = ($test->is_active==true)? route("suuji.module.test.deactivate",$test->id) : "";

                $activate_record = ($test->is_active==true)? "" : route("suuji.module.test.activate",$test->id);
     ...
     *
     * @param \App\SuujiModuleTest $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(SuujiModuleTest $model)
    {
