...
class BunpouVocabTestDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function($test){
                $__route_name = 'bunpou.vocabulary.test.edit';
                $__route_name_delete = 'bunpou.vocabulary.test.destroy';
                $edit_url = route($__route_name, $test->id);
                $delete_url = route($__route_name_delete, $test->id);

                $deactivate_record = ($test->is_active==true)? route("bunpou.vocabulary.test.deactivate",$test->id) : "";

                $activate_record = ($test->is_active==true)? "" : route("bunpou.vocabulary.test.activate",$test->id);
     ...
     *
     * @param \App\BunpouVocabTest $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BunpouVocabTest $model)
    {
