    ...
    public function query(ParticleMiniCourseQuestion $model)
    {
        ...
        return $model->newQuery()
            ...
            ->select([
                ...
                'particle_mini_course_questions.question_romanji',
                'particle_mini_course_questions.question_idn',
    ...
    protected function getColumns()
    {
        ...
        return [
            Column::make('rownum')
                ...
                ->searchable(false),
            // Column::make('code'),
            Column::make('question_jpn')->title('Pertanyaan Japan'),
            Column::make('question_romanji')->title('Pertanyaan Japan'),
            Column::make('question_idn')->title('Pertanyaan Japan'),
