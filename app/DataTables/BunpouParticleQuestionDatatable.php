...
class BunpouParticleQuestionDatatable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        ...
        return datatables()
            ...
            ->addColumn('action', function($question){
                $__route_name = 'bunpou.particle.question.edit';
                $__route_name_delete = 'bunpou.particle.question.destroy';
     ...
     *
     * @param \App\BunpouParticleQuestion $model
     * @return \Illuminate\Database\Eloquent\Builder
     */
    public function query(BunpouParticleQuestion $model)
    {
    ...
    {
        $id = 'bunpou-vocab-question-dt';
        $domScript = "data.module = $('#$id-module').val(); data.chapter = $('#$id-chapter').val(); data.test = $('#$id-test').val();";
        ...
        return $this->builder()
                    ...
                    ->dom('<"row"<"col-sm-2 section-module"><"col-sm-2 section-chapter"><"col-sm-2 section-test"><"col-sm-3"><"col-sm-3"f>> <"row"<"col-sm-12"tr>> <"row"<"col-sm-4"l><"col-sm-3"i><"col-sm-5"p>>')
                    ->orderBy(0,'asc')
                    ->responsive(true)
                    ->processing(true)
                    ->serverSide(true)
