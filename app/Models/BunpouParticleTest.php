...
class BunpouParticleTest extends Model
{
    protected $table = 'bunpou_particle_tests';
    protected $guarded = ['id'];

    public function data($param1=null,$param2=null,$param3=null)
    {
        $data = BunpouParticleTest::select([
            'id',
            'title',
            'chapter',
            'time',
    ...
    public function isActive(){
        return BunpouParticleTest::where("is_active",true)->orderBy("order","asc");
    }
}
