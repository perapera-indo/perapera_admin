    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Kanji Question</h4>
                        <br>
                        <form class="forms-sample"
                            action="{{ @$data ? route('kanji-course-questions.update', $data->id) : route('kanji-course-questions.store') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="kanji_course_id">Pick Kanji Course</label>
                                        <select name="kanji_course_id" id="kanji_course_id" class="form-control" required>
                                            <option value="">Select Kanji Course</option>
                                            @foreach ($courses as $course)
                                                <option value="{{ $course->id }}"
                                                    {{ $course->id == @$data->kanji_course_id ? 'selected' : '' }}>
                                                    {{ $course->title }}</option>
                                            @endforeach
                                        </select>
                                        {!! $errors->first('kanji_course_id', '<label class="help-block error-validation">:message</label>') !!}
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('kanji-course-questions.index') }}"
