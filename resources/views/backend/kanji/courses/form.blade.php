...
@endphp
@section('title', 'Kanji Course ' . $title)
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Kanji Course</h4>
                        <br>
                        <form class="forms-sample"
                            action="{{ @$data ? route('kanji-courses.update', $data->id) : route('kanji-courses.store') }}"
                            ...
                            <a href="{{ route('kanji-courses.index') }}"
