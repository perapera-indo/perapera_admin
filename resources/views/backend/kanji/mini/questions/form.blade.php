...
@endphp
@section('title', 'Kanji Mini ' . $title)
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Kanji Mini Question</h4>
                        <br>
                        <form class="forms-sample"
                            action="{{ @$data ? route('kanji-mini-course-questions.update', $data->id) : route('kanji-mini-course-questions.store') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="kanji_mini_course_id">Pick Kanji Mini Course</label>
                                        <select name="kanji_mini_course_id" id="kanji_mini_course_id" class="form-control" required>
                                            <option value="">Select Kanji Mini Course</option>
                                            @foreach ($courses as $course)
                                                <option value="{{ $course->id }}"
                                                    {{ $course->id == @$data->kanji_mini_course_id ? 'selected' : '' }}>
                                                    {{ $course->title }}</option>
                                            @endforeach
                                        </select>
                                        {!! $errors->first('kanji_mini_course_id', '<label class="help-block error-validation">:message</label>') !!}
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('kanji-mini-course-questions.index') }}"
