...
@section('title', "Bunpou Vocabulary Versi Test List")
@section('content')
    <style>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            @isPermitted('bunpou.vocabulary.test.create')
                                <a href="{{ route('bunpou.vocabulary.test.create') }}" type="button" class="btn btn-outline-info btn-rounded btn-fw btn-sm">
                        ...
                        <h4 class="card-title text-center table-title">List Bunpou Vocabulary Versi Test</h4>
                        <br>
                        <div class="col-md-12">
