...
@endphp
@section('title', 'Bunpou Vocabulary Test Question '.$title)
@section('content')
    <style>
    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Bunpou Vocabulary Test Question</h4>
                        <br>
                        <form class="forms-sample" isEdit="{{ ($title=='Add New')? 'false' : 'true' }}" id="form-question"
                            action="{{ @$question ? route('bunpou.vocabulary.question.update', $question->id) : route('bunpou.vocabulary.question.store') }}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="test">Vocabulary Versi Test</label>
                            ...
                            <a href="{{ route('bunpou.vocabulary.question.index') }}" class="btn btn-secondary btn-fw btn-lg">Cancel</a>
                        </form>
                    </div>
                </div>
            </div>
...
@section('scripts')
    <script>
        $(document).ready(function() {
            ...
            chapter.on("change", ()=>{
                $.ajax({
                    url: `{{ url('admin/bunpou/vocabulary/test') }}/${chapter.val()}/chapter`,
                    beforeSend: ()=>{
                        test.html("")
                    },
                    success: (res)=>{
