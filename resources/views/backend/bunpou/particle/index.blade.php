...
@section('title', "Bunpou Particle List")
@section('content')
    <style>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            @isPermitted('bunpou.particle.create')
                                <a href="{{ route('bunpou.particle.create') }}" type="button" class="btn btn-outline-info btn-rounded btn-fw btn-sm">
                        ...
                        <h4 class="card-title text-center table-title">List Bunpou Particle</h4>
                        <br>
                        <div class="col-md-12">
