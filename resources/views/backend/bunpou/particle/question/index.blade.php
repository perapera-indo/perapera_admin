...
@section('title', "Bunpou Particle Test Question List")
@section('content')
    <style>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            @isPermitted('bunpou.particle.question.create')
                                <a href="{{ route('bunpou.particle.question.create') }}" type="button" class="btn btn-outline-info btn-rounded btn-fw btn-sm">
                        ...
                        <h4 class="card-title text-center table-title">List Bunpou Particle Test Question</h4>
                        <br>
                        <div class="col-md-12">
            ...
            setCustomFilterDatatable({
                ...
                complete : (filter,section)=>{
                    ...
                    select.select2({
                        ...
                        $.ajax({
                            url: `{{ url('admin/bunpou/particle/test') }}/${value}/chapter`,
                            beforeSend: ()=>{
                                test.html("")
                            },
                            success: (res)=>{
