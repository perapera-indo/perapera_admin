...
@endphp
@section('title', 'Letter Category ' . $title)
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Letter Category</h4>
                        <br>
                        <form class="forms-sample"
                            action="{{ @$data ? route('letter-categories.update', $data->id) : route('letter-categories.store') }}"
