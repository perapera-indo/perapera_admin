...
@endphp
@section('title', 'Suuji Module Versi Test '.$title)
@section('content')
<div class="content-wrapper">
    <div class="row">
        <div class="col-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title">{{ $title }} Suuji Module Versi Test</h4>
                    <br>
                    <form class="forms-sample"
                          action="{{ @$data ? route('suuji.module.test.update', $data->id) : route('suuji.module.test.store') }}"
                        ...
                        <a href="{{ route('suuji.module.test.index') }}" class="btn btn-secondary btn-fw btn-lg">Cancel</a>
                    </form>
                </div>
            </div>
        </div>
