...
@section('title', 'Suuji Module Versi Test List')
@section('content')
    <style>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group">
                            @isPermitted('suuji.module.test.create')
                                <a href="{{ route('suuji.module.test.create') }}" type="button" class="btn btn-outline-info btn-rounded btn-fw btn-sm">
                                    <i class="mdi mdi-plus-circle btn-icon-prepend"></i> Tambah
                                </a>
                            @endisPermitted
                            <div class="pull-right">
                                <a href="{{ route('suuji.module.index') }}" type="button" class="btn btn-outline-info btn-rounded btn-fw btn-sm">
                        ...
                        <h4 class="card-title text-center table-title">List Suuji Module Versi Test</h4>
                        <br>
                        <div class="col-md-12">
