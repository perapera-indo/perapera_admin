    ...
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Pattern Question</h4>
                        <br>
                        <form class="forms-sample"
                            action="{{ @$data ? route('pattern-course-questions.update', $data->id) : route('pattern-course-questions.store') }}"
                                        ...
                                        <select name="pattern_course_id" id="pattern_course_id" class="form-control" required>
                                            ...
                                            @foreach ($courses as $course)
                                                <option value="{{ $course->id }}"
                                                    {{ $course->id == @$data->pattern_course_id ? 'selected' : '' }}>
                                                    {{ $course->title }}</option>
                                            @endforeach
                                        </select>
                                        {!! $errors->first('pattern_course_id', '<label class="help-block error-validation">:message</label>') !!}
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('pattern-course-questions.index') }}"
