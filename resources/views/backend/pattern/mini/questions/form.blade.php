...
@endphp
@section('title', 'Pattern Mini ' . $title)
@section('content')
    <div class="content-wrapper">
        <div class="row">
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title">{{ $title }} Pattern Mini Question</h4>
                        <br>
                        <form class="forms-sample"
                            action="{{ @$data ? route('pattern-mini-course-questions.update', $data->id) : route('pattern-mini-course-questions.store') }}"
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="pattern_mini_course_id">Pick Pattern Mini Course</label>
                                        <select name="pattern_mini_course_id" id="pattern_mini_course_id" class="form-control" required>
                                            <option value="">Select Pattern Mini Course</option>
                                            @foreach ($courses as $course)
                                                <option value="{{ $course->id }}"
                                                    {{ $course->id == @$data->pattern_mini_course_id ? 'selected' : '' }}>
                                                    {{ $course->title }}</option>
                                            @endforeach
                                        </select>
                                        {!! $errors->first('pattern_mini_course_id', '<label class="help-block error-validation">:message</label>') !!}
                                    </div>
                                </div>
                            ...
                            <a href="{{ route('pattern-mini-course-questions.index') }}"
